export default {
  wrongIpFormat: "This IP address is not valid",
  ...
  betweenLength:
    "The value must be between {minLength} and {maxLength} characters long",
  ...
  onlyDigits: "The value must contain only digits",
