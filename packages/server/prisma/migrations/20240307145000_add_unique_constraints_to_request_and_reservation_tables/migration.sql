...
*/
-- CreateIndex
CREATE UNIQUE INDEX "BookRequest_user_id_book_id_deleted_at_key" ON "BookRequest"("user_id", "book_id", "deleted_at");

-- CreateIndex
CREATE UNIQUE INDEX "Reservation_user_id_book_id_deleted_at_key" ON "Reservation"("user_id", "book_id", "deleted_at");
