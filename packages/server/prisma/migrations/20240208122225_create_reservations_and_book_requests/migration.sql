...
-- AddForeignKey
ALTER TABLE "BookRequest" ADD CONSTRAINT "BookRequest_deleted_by_id_fkey" FOREIGN KEY ("deleted_by_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
